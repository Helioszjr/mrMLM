...
**Aula: Mapeamento por Associação (GWAS), ministrada pela Dra. Sthephanie Alves.**

Arquivo elaborado por [Helio de Souza Junior](https://github.com/Helioszjr), com
...
mrMLM v4.0.2: An R Platform for Multi-locus Genome-wide Association Studies. [https://doi.org/10.1016/j.gpb.2020.06.006](https://doi.org/10.1016/j.gpb.2020.06.006).
...
Temos também a opção de usar o Shiny sem precisar elaborar as linhas de comandos

O mrMLM.GUI é iniciada por meio dos dois comandos " library (mrMLM.GUI)" e " mrMLM.GUI ()". Foi desenvolvido com base no Shiny.
...
![](img/20.png){fig-align="center"}

Para mais informções abrir o [Manual PDF](https://cran.r-project.org/web/packages/mrMLM/mrMLM.pdf).